...
## 目標
建置一個以「服務導向」為核心的國立中正大學外籍生友善校園導引系統，核心功能為「關鍵字搜尋服務需求」與「服務類別篩選」。
...
理由：此設計最符合本專案的核心目標——幫助外籍生「從需求出發找到正確單位」。機場/地鐵式的指標系統設計天然就是為了「引導陌生人到達目的地」而生，與本專案的服務導向定位完美契合。深藍與琥珀色的配色方案既專業又溫暖，左側的「服務線」導航能清楚呈現服務類別的層級關係，而「到達卡片」的設計則完美解決了「到達建築後不知道下一步」的痛點。
