...
export type HandbookBlock =
  ...
  | { type: "note"; tone?: "info" | "warning"; content_en: string; content_zh: string }
        ...
        blocks: [
          {
            ...
            tone: "warning",
            content_en:
              "If visa extension is not completed before the expiry date, the student may have to leave Taiwan.",
        ...
        blocks: [
          {
            ...
            rows: [
              {
                item: { en: "ARC application", zh: "ARC 申請" },
                estimate: "NT$1,000",
                note: { en: "Only for students staying more than six months.", zh: "僅適用於停留超過六個月者。" },
              },
              {
                item: { en: "Visitor visa extension", zh: "停留簽證延期" },
                estimate: "NT$600",
                note: { en: "Apply before visa expiry.", zh: "請於簽證到期前申請。" },
              },
              {
                item: { en: "On-campus dormitory", zh: "校內宿舍" },
                estimate: "US$310-360",
                note: { en: "Depends on exchange agreement.", zh: "依交換協議而定。" },
              },
              {
                item: { en: "Health check", zh: "健康檢查" },
                estimate: { en: "Around US$25", zh: "約 US$25" },
                note: { en: "May be higher if completed off campus.", zh: "若自行至校外醫院辦理，費用可能較高。" },
              },
            ],
          },
        ],
        ...
        blocks: [
          {
            ...
            tone: "warning",
            content_en:
              "Only degree-seeking students can apply for a work permit. Exchange and visiting students are not allowed to work in Taiwan.",
