...
import {
  ArrowLeft, ChevronDown, ChevronUp, MapPin, Navigation,
  ClipboardList, Building2, CheckCircle2
} from "lucide-react";
      ...
      <div className="container py-6 flex-1 max-w-3xl">
        <div className="space-y-3">
          {tasks.map(task => {
            ...
            return (
              <div key={task.id} className="bg-card rounded-xl border border-border overflow-hidden shadow-sm">
                <button
                    ...
                    {targetName && (
                      <div className="bg-cream rounded-lg p-3 mb-4">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <span className="font-display font-semibold text-sm text-navy">{targetName}</span>
                        </div>
