...
export const departments: Department[] = [
  ...
  },
  {
    ...
    "latitude": 23.561255646669387,
    "longitude": 120.47359415707793,
    "source_url": "",
    "needs_manual_review": false,
    "is_college_office": false,
  ...
  },
  {
    ...
    "official_url": "",
    "google_maps_query": "國立中正大學創新大樓",
    "latitude": 23.561277350056283,
    "longitude": 120.47904045644809,
    "source_url": "",
    "needs_manual_review": false,
    "is_college_office": false,
  ...
  },
{
  ...
  },
  {
    ...
    "steps": [
      {
        "zh": "前往華語中心頁面查看開班資訊。",
        "en": "Visit the Chinese Language Center page to check available class schedules.",
        "links": [
          {
            "url": "https://chineselanguagecenter.ccu.edu.tw/",
            "label_zh": "開啟華語中心頁面",
            "label_en": "Open Chinese Language Center Page"
          }
        ]
      },
      {
        "zh": "請依開班資訊網頁公告下載並填寫報名表。",
        "en": "Please download and complete the application form according to the latest course announcement.",
        "links": [
          {
            "url": "https://chineselanguagecenter.ccu.edu.tw/",
            "label_zh": "開啟華語中心頁面",
  ...
  },
  {
    ...
    "steps": [
      ...
      {
        "zh": "團體使用或辦活動時，請先至體育中心頁面確認租借費用。",
        "en": "For group use or events, check rental fees on the Sports Center page first.",
        "links": [
          {
            "url": "https://sport.ccu.edu.tw/",
            "label_zh": "開啟體育中心頁面",
            "label_en": "Open Sports Center Page"
          }
        ]
      },
      {
  ...
  },
  {
    ...
    "steps": [
      ...
      {
        "zh": "健身房時刻表採滾動式更新，可前往體育中心頁面搜尋「weight training room」查看。",
        "en": "The fitness room schedule is updated regularly. Go to the Sports Center page and search for “weight training room” to view the schedule.",
        "links": [
          {
            "url": "https://sport.ccu.edu.tw/",
            "label_zh": "開啟體育中心頁面",
      ...
      {
        "zh": "詳細資訊可參考體育中心頁面；國定假日不對外開放。",
        "en": "For full details, refer to the Sports Center page. Facilities are closed to the public on national holidays.",
        "links": [
          {
            "url": "https://sport.ccu.edu.tw/",
            "label_zh": "開啟體育中心頁面",
  ...
  },
  {
    ...
    "steps": [
      ...
      {
        "zh": "詳細資訊可參考 https://www.ccu.edu.tw/p/404-1000-25665.php?Lang=zh-tw。",
        "en": "For full details, refer to https://www.ccu.edu.tw/p/404-1000-25665.php?Lang=zh-tw."
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "steps": [
      {
        "zh": "可使用嘉義公車即時動態頁查詢路線與到站資訊。",
        "en": "Use the Chiayi bus real-time information page to check routes and arrival information.",
        "links": [
          {
            "url": "https://taiwanhelper.com/bus/CYI",
            "label_zh": "開啟嘉義公車即時動態",
            "label_en": "Open Chiayi Bus Real-Time Information"
          }
        ]
      },
      {
